  ...
  return (
    <Box sx={{ py: 10 }}>
      <Container>
        <CustomBox>
          <ImgContainer>
            <Image src={HouseCard} alt="house card" />
          </ImgContainer>
          ...
          <Box>
            ...
            >
              When you own a home, you commit to living in one location for a period of time. We are
              here to ensure that this will be a memorable experience for you.
            </Typography>
          </Box>
        </CustomBox>
